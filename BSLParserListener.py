...
class BSLParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by BSLParser#beforeExecPart.
    def enterBeforeExecPart(self, ctx:BSLParser.BeforeExecPartContext):
        pass

    # Exit a parse tree produced by BSLParser#beforeExecPart.
    def exitBeforeExecPart(self, ctx:BSLParser.BeforeExecPartContext):
        pass


    # Enter a parse tree produced by BSLParser#procedureDeclarationCore.
    def enterProcedureDeclarationCore(self, ctx:BSLParser.ProcedureDeclarationCoreContext):
        pass

    # Exit a parse tree produced by BSLParser#procedureDeclarationCore.
    def exitProcedureDeclarationCore(self, ctx:BSLParser.ProcedureDeclarationCoreContext):
        pass


    # Enter a parse tree produced by BSLParser#functionDeclarationCore.
    def enterFunctionDeclarationCore(self, ctx:BSLParser.FunctionDeclarationCoreContext):
        pass

    # Exit a parse tree produced by BSLParser#functionDeclarationCore.
    def exitFunctionDeclarationCore(self, ctx:BSLParser.FunctionDeclarationCoreContext):
        pass


    # Enter a parse tree produced by BSLParser#closedParamList.
    def enterClosedParamList(self, ctx:BSLParser.ClosedParamListContext):
        pass

    # Exit a parse tree produced by BSLParser#closedParamList.
    def exitClosedParamList(self, ctx:BSLParser.ClosedParamListContext):
        pass
